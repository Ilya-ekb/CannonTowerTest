...
namespace UnityStandardAssets.CrossPlatformInput.Inspector
{
    ...
    public class CrossPlatformInitialize
    {
        ...
        [Obsolete("Obsolete")] private static BuildTargetGroup[] buildTargetGroups = new BuildTargetGroup[]
            {
        ...
        [Obsolete("Obsolete")] private static BuildTargetGroup[] mobileBuildTargetGroups = new BuildTargetGroup[]
            {
                BuildTargetGroup.Android,
                BuildTargetGroup.iOS,
                BuildTargetGroup.WP8,
